...
import marinermod.cards.attacks.Shipshape;
import marinermod.cards.attacks.Strike;
import marinermod.cards.skills.Defend;
import marinermod.cards.skills.ReefWalk;
import marinermod.relics.EncrustedSpyglass;

import java.util.ArrayList;

import static marinermod.MarinerMod.characterPath;
import static marinermod.MarinerMod.makeID;

public class MarinerCharacter extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Mariner"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass MARINER;
        @SpireEnum(name = "DARK_TEAL") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "DARK_TEAL") @SuppressWarnings("unused")
        ...
        private static final Color cardColor = new Color(0f/255f, 117f/255f, 53f/255f, 1f);
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new MarinerCharacter(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public MarinerCharacter() {
        super(getNames()[0], Meta.MARINER,
        ...
        this.img = ImageMaster.loadImage(MarinerMod.characterPath("themariner.png"));
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Defend.ID);
        retVal.add(Defend.ID);
        retVal.add(Shipshape.ID);
        retVal.add(ReefWalk.ID);
        return retVal;
    }
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(EncrustedSpyglass.ID);
    ...
    public int getAscensionMaxHPLoss() {
        return 3; //Max hp reduction at ascension 14+
    }
